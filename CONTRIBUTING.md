...
Thanks for considering a contribution to probe. This is an experimental, solo-maintained project. Contributions are welcome when they are focused, maintainable, and aligned with the project direction.
...
Use the commands documented in README.md for this repository. Before opening a pull request, run `bun run verify` and include the result in the PR description.
